...
@set ILCPATH="C:\Users\frank\.nuget\packages\runtime.win-x64.microsoft.dotnet.ilcompiler\7.0.14"\tools
...
csc /platform:x64 /define:WINDOWS /debug:embedded /noconfig /nostdlib /runtimemetadataversion:v4.0.30319 zerosharp.cs /out:zerosharp.ilexe /langversion:latest /unsafe || goto Error
...
link /machine:x64 /libpath:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\um\x64" /debug /subsystem:console zerosharp.obj /entry:__managed__Main kernel32.lib /incremental:no || goto Error
